...
|---|---|---|
| `csv_data_dict` | 317 | "ไฟล์นี้แปลว่าอะไร" — ความหมายรายคอลัมน์ · ขอบเขตปี/จังหวัด · ข้อควรระวัง · นิยาม/ตัวตั้ง/ตัวหาร/เป้าหมาย |
| `hdc_import` | 288 | "ไฟล์นี้มาจากไหน" — ชื่อตารางต้นทาง · ลิงก์รายงาน · ปีที่ใช้ได้ · เวลาซิงก์ · `date_com` รายจังหวัด |
